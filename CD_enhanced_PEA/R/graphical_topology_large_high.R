...
sim_large_top_high <- large_topology[[3]]

data_list = NULL
theta_list = NULL

for (i in 1:length(sim_large_top_high)){
  data_list[[i]] = sim_large_top_high[[i]]$data
  theta_list[[i]] = sim_large_top_high[[i]]$theta
}
...
save(output, file = "../data/Graphical_top_large_high.RData")