...
sim_large_top_dis <- large_topology[[1]]

data_list = NULL
theta_list = NULL

for (i in 1:length(sim_large_top_dis)){
  data_list[[i]] = sim_large_top_dis[[i]]$data
  theta_list[[i]] = sim_large_top_dis[[i]]$theta
}
...
save(output, file = "../data/Graphical_top_large_dis.RData")